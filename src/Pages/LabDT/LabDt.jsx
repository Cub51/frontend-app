...
const LabDT = () => {
    ...
    const exportToJson = () => {
        ...
        const jsonString = JSON.stringify(elementsJson);
    ...
    const importFromJson = () => {
        ...
        input.onchange = async (event) => {
            ...
            const elementsJson = JSON.parse(jsonString);

            const newElements = elementsJson.map((element) => {
                if (element.type === "line" || element.type === "rectangle") {
                    ...
                    return createElement(elements.length, 0, 0, 0, 0, element.type);
                } else if (element.type === "text") {
                    return createElement(
                        elements.length,
                        element.x1,
            ...
            setElements((prevState) => [...prevState, ...newElements]);
        };
    ...
    return (
        ...
        <ToolBar />
            <section>
                <div style={{ position: "fixed", zIndex: 2, marginTop: "50px"}}>
                    <input
                        type="radio"
                        id="selection"
                ...
                <div>
                    <canvas
                        ...
                        style={{ position: "sticky", zIndex: 1 }}//Revisar
