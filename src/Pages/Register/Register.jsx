...
const Register = () => {
  ...
  const { nombre, apellido, contrasena, correo } = inputs;
    ...
    <>
      <div className={styles.formContainer}>
        ...
        <form onSubmit={(e) => onSubmit(e)}>
          ...
          <button type="submit">{loading ? "C a r g a n d o ..." : "R e g i s t r a r m e"}
          </button>

          <p> Ya tienes una cuenta? {" "}
            <a href="/login" className="icon-link icon-link-hover" >Iniciar Sesion
